...
func (c *userClient) Login(ctx context.Context, in *UserLoginReq, opts ...grpc.CallOption) (*UserLoginReqResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserLoginReqResp)
...
type UserServer interface {
	...
	Login(context.Context, *UserLoginReq) (*UserLoginReqResp, error)
...
func (UnimplementedUserServer) Login(context.Context, *UserLoginReq) (*UserLoginReqResp, error) {
